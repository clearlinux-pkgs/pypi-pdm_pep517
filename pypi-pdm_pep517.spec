...
Version  : 1.1.2
Release  : 18
URL      : https://files.pythonhosted.org/packages/0b/9a/960ef9bd4e73f69e74865f042ea69051ec0bd21ff2a70d2d5592d20a7784/pdm-pep517-1.1.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/0b/9a/960ef9bd4e73f69e74865f042ea69051ec0bd21ff2a70d2d5592d20a7784/pdm-pep517-1.1.2.tar.gz
...
%prep
%setup -q -n pdm-pep517-1.1.2
cd %{_builddir}/pdm-pep517-1.1.2
pushd ..
cp -a pdm-pep517-1.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675785460
