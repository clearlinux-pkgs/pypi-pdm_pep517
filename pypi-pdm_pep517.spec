...
Source0  : https://files.pythonhosted.org/packages/24/b6/1b06ac9506f531ef952217a20063413523c4192642b2e984433b2dc97919/pdm-pep517-1.0.3.tar.gz
...
%prep
%setup -q -n pdm-pep517-1.0.3
cd %{_builddir}/pdm-pep517-1.0.3
pushd ..
cp -a pdm-pep517-1.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658965931
