...
Version  : 1.0.6
Release  : 15
URL      : https://files.pythonhosted.org/packages/16/d0/b4db0af67f40ad63b42040352c1175b4af55d93500478bb7a1a29d8d5843/pdm-pep517-1.0.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/16/d0/b4db0af67f40ad63b42040352c1175b4af55d93500478bb7a1a29d8d5843/pdm-pep517-1.0.6.tar.gz
...
%prep
%setup -q -n pdm-pep517-1.0.6
cd %{_builddir}/pdm-pep517-1.0.6
pushd ..
cp -a pdm-pep517-1.0.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669396909
...
cp %{_builddir}/pdm-pep517-%{version}/pdm/pep517/_vendor/pyparsing/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pdm_pep517/df156c6a0a89ed2a3bd4a473c68cf85907509ca0 || :
