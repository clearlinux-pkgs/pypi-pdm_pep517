...
Source0  : https://files.pythonhosted.org/packages/8a/8f/799f7b88c1333115db197dfc0ea3c3a7d57f1b9fb7d9f9151a92ebd2d2d6/pdm-pep517-1.0.4.tar.gz
...
%prep
%setup -q -n pdm-pep517-1.0.4
cd %{_builddir}/pdm-pep517-1.0.4
pushd ..
cp -a pdm-pep517-1.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659971568
